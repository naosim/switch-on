...
function () {
  ...
  Answers.prototype.notifyUpdate = function () {
    var ary = Object.values(this.valueMap);
    this.yesCount = ary.filter(function (v) {
      return v.isYes;
    }).length;
    this.noCount = ary.filter(function (v) {
      return v.isNo;
    }).length;
...
},{}],"vNpH":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  SwitchOnSpeaker.prototype.openWebSocket = function (callback) {
...
},{}],"swQP":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  SwitchOnWebSocketImpl.prototype.throwIfNotOpen = function () {
    if (!this.socket) {
...
},{"../domain/Answer":"vNG5","../domain/User":"vNpH","../domain/EventId":"swQP"}],"BHXf":[function(require,module,exports) {
"use strict";
    ...
    pressCreateRoomButton: function pressCreateRoomButton() {
      ...
      if (this.apiKey && this.apiKey.length > 0 && this.channel && this.channel.length > 0) {
        ...
        switchOnSpeaker.openWebSocket(function (e) {
          ...
          _this.isInRoom = true;
          _this.audienceUrl = "" + location.origin + location.pathname.split('speaker').join('audience') + "?ws=" + encodeURIComponent(webSocketIn.url);
        });
      }
    },
